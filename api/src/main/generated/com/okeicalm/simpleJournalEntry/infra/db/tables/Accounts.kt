...
open class Accounts(
    ...
    /**
     * The column <code>simple_journal_entry_db.accounts.category</code>.
     */
    val CATEGORY: TableField<AccountsRecord, AccountsCategory?> = createField(DSL.name("category"), SQLDataType.VARCHAR(11).nullable(false).defaultValue(DSL.inline("ASSETS", SQLDataType.VARCHAR)).asEnumDataType(com.okeicalm.simpleJournalEntry.infra.db.enums.AccountsCategory::class.java), this, "")
